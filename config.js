...
module.exports = {
    ...
    BOT_NAME:              process.env.BOT_NAME || "𝗠𝗨𝗗𝗔𝗦𝗦𝗔𝗥 𝗠𝗗",
    OWNER_NUMBER:          process.env.OWNER_NUMBER || "923264212004",
    OWNER_NAME:            process.env.OWNER_NAME || "𝙈𝙐𝘿𝘼𝙎𝙎𝘼𝙍 شہنشاہ",
    DESCRIPTION:           process.env.DESCRIPTION || "𝗠𝗨𝗗𝗔𝗦𝗦𝗔𝗥 𝗠𝗗 Bot",
    ALIVE_IMG:             process.env.ALIVE_IMG || "./menu.jpg",
    LIVE_MSG:              process.env.LIVE_MSG || "𝗠𝗨𝗗𝗔𝗦𝗦𝗔𝗥 𝗠𝗗 is active",
    ...
    AUTO_STATUS_MSG:       process.env.AUTO_STATUS_MSG || "Seen by 𝗠𝗨𝗗𝗔𝗦𝗦𝗔𝗥 𝗠𝗗",
    ...
    STATUS_MSG:            process.env.STATUS_MSG    || 'MUDASSAR MD 💖 SUCCESSFULLY VIEWED YOUR STATUS',
